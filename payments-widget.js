(function () {
  ...
  // Load items, render widget. If the network or API fails, show a friendly message.
  fetch(BASE + "/api/v1/store/items?group=" + encodeURIComponent(GROUP))
    ...
    .catch(function () { if (el) el.innerHTML = '<p style="font:13px system-ui,sans-serif;color:#9ca3af">Unable to load store right now.</p>'; });
})();
